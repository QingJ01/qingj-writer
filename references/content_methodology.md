...
**方法论型**
把长期积累的经验系统性地分享出来。最考验"知行合一"——说的每一条自己得真做过。
- 用AI三年的9条心得 → 每条配自己的踩坑经历 → 坦诚说明学习曲线
- 如何找回你的创造力 → 从自己的困境切入 → 每节落到可执行行动
写法核心：谦逊铺垫 → 每节有可执行建议 → 坦诚失败点和学习成本 → 结尾回扣升华

---

## 3. 多平台选题适配

同一个素材/话题在不同平台的选题逻辑不同：

### 公众号/知乎专栏（模式A）

选题要"值得花10分钟读完"。偏好深度、完整性、有升华的内容。

适合的选题：
- 需要亲自下场调查的话题（调查实验型）
- 需要大量论述和案例支撑的观点（现象解读型）
- 系统性方法论输出（方法论型）
- 有足够多功能/场景可以展示的产品体验（产品体验型）

不适合的选题：
- 一句话就能说清的信息（发推特）
- 纯操作步骤教程（发小红书）
- 时效性极强、等你写完就过气了的热点（发推特抢时间）

### 知乎问答（模式B）

选题要"这个问题下缺一个有亲身经历的好回答"。偏好差异化和干货密度。

适合的选题：
- 你有独特经历或视角的问题
- 主流回答都在说正确的废话，你能给具体方法的问题
- 争议性话题，你能讲清楚两面的问题
...
一个好素材经常可以拆成多平台内容：
1. 推特先发第一反应/核心观点（抢时效）
2. 小红书发操作步骤/效果截图（吃搜索流量）
3. 公众号/知乎出深度长文（吃长尾价值）

顺序很重要。短内容抢时间窗口，长内容不怕晚但要有深度。
...
**长文（模式A）**：像一首完整的歌，有前奏、主歌、副歌、桥段、尾声。允许偏离主线去看风景，但每次都要拉回来。全文节奏是波动的，有高有低，有紧有松。

**知乎回答（模式B）**：像一段即兴演讲，开头抓住人之后一口气推到底。节奏更紧凑，偏离主线的空间更小。每段都要推进论述，不能只是"聊天"。

**短内容（模式C）**：像一拳打出去。没有波动的空间，每个字都是节奏本身。

### 对标参考

**长文/视频节奏**：影视飓风、何同学、小狮日记、毕导、小Lin、九边
**知乎回答节奏**：半佛仙人（锐利+干货）、温义飞（故事+知识）
**短内容节奏**：Elon Musk推特（极简锐利）、flomo少楠（碎碎念洞察）
